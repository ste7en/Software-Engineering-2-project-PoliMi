...
\section{Assumptions, Dependencies and Constraints}
 ...
 \subsection{Constraints}
 	\begin{itemize}
 		...
 		\item User registered must accept the \ic{Privacy statement};
 		...
 		\item All the collected \ic{User reports} must not be accessible by unauthorized people, but only by the \ic{Municipality};
