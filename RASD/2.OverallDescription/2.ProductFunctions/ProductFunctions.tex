...
\begin{document}
	...
	\ic{Municipality} will visualize the list of \ic{User reports}, select one and generate or not a \ic{Traffic ticket}. If \ic{Municipality} discard a \ic{User report}, it will select a reason among those provided.
