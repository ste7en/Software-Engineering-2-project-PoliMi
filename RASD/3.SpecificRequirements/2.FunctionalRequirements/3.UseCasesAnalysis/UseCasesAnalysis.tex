...
\begin{center}
	\begin{longtable}{| p{.25\linewidth} | p{.75\linewidth} |}
		...
		Exceptions & 
		\begin{enumerate}
			\item %TODO ???(Corrupted data: Discard report)
		\end{enumerate}
		%TODO
		. \\ 
		\hline
...
\begin{center}
	\begin{longtable}{| p{.25\linewidth} | p{.75\linewidth} |}
		...
		Exceptions & 
		\begin{enumerate}
			\item \ic{User} has not yet reported any \ic{Traffic violation};
		\end{enumerate}
		A warning is shown and \ic{User} is sent back to the main page.
		\\ \hline
		\caption*{U\subs{9}}
	\end{longtable}
\end{center}
