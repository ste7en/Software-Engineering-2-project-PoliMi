...
In addition, integrity about every information, coming from the \ic{User}, related to the \ic{User report}, must be granted by SafeStreets before it is sent to the \ic{Municipality}. Information must not be altered or corrupted. 
