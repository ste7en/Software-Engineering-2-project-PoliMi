...
\subsection{Business logic tier\label{sect:2.2.3}}
	...
	\item[Accidents Manager]: contains all the business logic in order to send and receive periodically \ic{Accidents} data from \ic{Municipality}, loading and storing them in Accidents Database through Accidents DAO. It also collects Accidents data stored in Accidents database basing on particular parameters;
