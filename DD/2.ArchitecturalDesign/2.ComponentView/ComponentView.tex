...
\subsection{Service tier\label{sect:2.2.2}}
	\begin{description}
	\item[Apache Web Server]: must communicate with the \ic{User}'s Mobile Application and the \ic{Municipality} Browser through HTTP protocol (HTTPS connection); its primary function is to store, process and deliver web pages to requesting clients.
	\end{description}
